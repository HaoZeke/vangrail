...
File.write(OUT, <<~RUBY)
  ...
  module Vangrail
    ...
    # candidate files against the #{context_benign_n} below. The published attack
    # corpora are hash-pinned in evaluation/benchmark_sources.json and fetch
    # reproducibly; the benign context side is the half that does not.
    #
